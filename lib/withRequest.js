...
function withRequest(request, _a) {
    var _b = _a === void 0 ? {} : _a, _c = _b.prefix, prefix = _c === void 0 ? '' : _c, _d = _b.defaultResponse, defaultResponse = _d === void 0 ? undefined : _d, _e = _b.overlapStrategy, overlapStrategy = _e === void 0 ? 'cancel' : _e, _f = _b.resetErrorOnResponse, resetErrorOnResponse = _f === void 0 ? true : _f, _g = _b.resetResponseOnError, resetResponseOnError = _g === void 0 ? false : _g;
    var _h;
    ...
    return recompose_1.compose(recompose_1.withStateHandlers({
        ...
        request: function (props) { return function () {
            ...
            var promise = new cancelable_promise_1.default(function (resolve) { return resolve(request(props).apply(void 0, args)); });
            promise
    ...
    }), recompose_1.branch(function () { return !!prefix; }, recompose_1.compose(recompose_1.withHandlers((_h = {},
        _h[prefix + "Request"] = function (_a) {
            var request = _a.request;
            return request;
        },
        _h[prefix + "ClearError"] = function (_a) {
            var clearError = _a.clearError;
            return clearError;
        },
        _h)), recompose_1.mapProps(function (_a) {
